...
define(
    function (require) {
        ...
        ControlCollection.prototype.invoke = function (methodName) {
            ...
            // 类似 args.push(...args)
            args.push.apply(args, arguments); // args: [this, methodName, otherArgs...]
            // u.invoke(this, methodName, ortherArgs...)
            return u.invoke.apply(u, args);  // u.invoke(...args) 参考es6中...的展开用法
        };
        ...
        u.each(
            ...
            function (method) {
                ControlCollection.prototype[method] = function () {
                    var args = [method];
                    args.push.apply(args, arguments); // args: [method, ...arguments]
                    var result = this.invoke.apply(this, args); // this.invoke(...args)
        ...
        u.each(
            ...
            function (method) {
                ControlCollection.prototype[method] = function () {
                    var first = this[0];
                    return first
                        ? first[method].apply(first, arguments) // first[method](...arguments)
                        : undefined;
                };
            }
        );
