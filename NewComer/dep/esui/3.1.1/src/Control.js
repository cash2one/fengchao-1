...
define(
    function (require) {
        ...
        Control.prototype = {
             ...
             * @fires afterrender
             */
            // MARK 调用子类的 initStructure/initEvents，为main元素添加相关的样式，调用子类的repaint
            render: function () {
                if (this.helper.isInStage('INITED')) {
                    ...
                    // MARK 在控件的主元素上添加 样式名(样式名的算法可以查看Helper中的方式)
            ...
            addState: function (state) {
                if (!this.hasState(state)) {
                    ...
                    this.helper.addStateClasses(state); // MARK 添加和这个state相关的样式
                    var properties = {};
